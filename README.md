...
@JamesCullum - Office 365, Protonmail

Installation
You can either use a precompiled binary package for your architecture, use a Docker container or you can compile evilginx2 from source.
